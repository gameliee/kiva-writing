...
\newcommand{\defensedate}{19 December 2023} 															%% Date de soutenance / Date of defense
...
\newcommand{\jurynameBb}{NGUYEN Linh Trung}
\newcommand{\juryadressBb}{VNU University of Engineering and Technology}
\newcommand{\juryroleBb}{Examiner}

%%% Membre n°4 (Examinateur) / Member n°4 (Examiner)
\newcommand{\jurynameCa}{Salah EL AYOUBI}
\newcommand{\juryadressCa}{L2S, CentraleSupélec-Paris-Saclay University}
\newcommand{\juryroleCa}{Examiner}

%%% Membre n°5 (Examinateur) / Member n°5 (Examiner)
\newcommand{\jurynameCb}{TRAN Trong Hieu}
...
\newcommand{\juryadressE}{IDHES, ENS-Paris-Saclay University}
...
\newcommand{\juryadressF}{L2S, CentraleSupélec-Paris-Saclay University}
...
\begin{textblock}{12}(3.7,3.5)
	...
	\begin{flushright}
		...
		\normalsize \textbf{Master thesis of Paris-Saclay University and \\VNU University of Engineering and Technology} \\ \bigskip
		\vspace{5mm}
		\vfill
	...
	\begin{flushleft}
	\begin{tabular}{|p{8cm}l}%{@{} L{9.5cm} R{4.5cm}}
	...
	\begin{flushleft}
	\begin{tabular}{|p{8cm}ll}%{@{} L{9.5cm} R{4.5cm}}
	    \arrayrulecolor{Prune}
