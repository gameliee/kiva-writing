...
$p_{stay}$ is the probability that a node stay in the same community from time $T_i$ to $T_{i+1}$,
and it can switch to a new community with probability $1-p_{stay}$ as illustrated in figure \ref{fig:synthesis_graph}.
